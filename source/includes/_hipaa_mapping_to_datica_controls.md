# HIPAA Mappings to DNA Genotek Controls

Below is a list of HIPAA Safeguards and Requirements and the DNA Genotek controls in place to meet those.

| **Administrative Controls** HIPAA Rule | DNA Genotek Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | DNA Genotek Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | DNA Genotek Control
---------------- | ----------------
