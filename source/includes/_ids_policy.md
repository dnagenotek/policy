...
In order to preserve the integrity of data that DNA Genotek stores, processes, or transmits for Customers, DNA Genotek implements strong intrusion detection tools and policies to proactively track and retroactively investigate unauthorized access. DNA Genotek currently utilizes [OSSEC](http://www.ossec.net/) to track file system integrity, monitor log data, and detect rootkit access.
...
* DNA Genotek firewalls monitor all incoming traffic to detect potential denial of service attacks. Suspected attack sources are blocked automatically. Additionally, our hosting provider actively monitors its network to detect denial of services attacks.
...
* DNA Genotek utilizes redundant firewall on network perimeters.
* Static IP addresses are used for DNA Genotek servers.
